  ...
  return (
    <div className="card space-y-4 p-6 text-sm text-slate-300">
      ...
      <p>
        ...
        Include your Google account email and Supabase user ID (visible on the account page). We will remove entries from the <code>users</code>, <code>layouts</code>, <code>follows</code>, and <code>alerts</code> tables within 72 hours.
      </p>
      <p>
