    ...
    <div className="space-y-10">
      <section className="card space-y-4 p-8 text-center">
        ...
        <p className="mx-auto max-w-2xl text-sm text-slate-300">
          ...
          automation, alert routing, and layout syncing. Stripe powers secure payments while Supabase updates your Google-linked profile in real time.
        </p>
      </section>
      ...
      <section className="card space-y-4 p-6 text-sm text-slate-300">
        ...
        <div className="space-y-3">
          ...
          <FaqItem question="What about data privacy?">
            We authenticate with Google OAuth and store only layout, follow, and alert metadata in Supabase. You can export or delete your information at any time via the data deletion portal.
          </FaqItem>
        </div>
      </section>
    </div>
